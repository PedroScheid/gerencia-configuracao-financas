...
echo "[1/7] Removendo containers da aplicacao..."
...
echo "[2/7] Removendo imagens da aplicacao..."
...
echo "[3/7] Removendo volumes da aplicacao..."
...
echo "[4/6] Removendo migration 002 (se existir)..."
...
echo "[5/6] Removendo erro de lint (se existir)..."
...
echo "[6/7] Restaurando cor verde no layout..."
...
echo ""
echo "  Removido: containers, imagens, volumes, migration 002"
